...
var Adaptor = module.exports = function Adaptor(opts) {
  ...
  this.i2c = null;
  this.breakoutBoard = opts.breakoutBoard || "arduino"
...
Adaptor.prototype._translatePin = function(pin) {
  switch (this.breakoutBoard) {
    case "sparkfun-gpio":
      return SPARKFUN_GPIO[pin];
    default:
      return pin;
  }
};
 ...
 *
 * @param {Number} pin pin number to read from
...
Adaptor.prototype.digitalRead = function(pin, callback) {
  ...
  pin = this._translatePin(parseInt(pin, 10));
 ...
 * @param {Number} value value to write to pin
 * @return {void}
 * @publish
 */
 ...
 * @param {Number} value value to write to pin
 * @param {Bool} servo whether values should be servo
 * @return {void}
 * @publish
 */
Adaptor.prototype.pwmWrite = function(pinNum, value, servo) {
  pinNum = this._translatePin(parseInt(pinNum, 10));
 ...
 * @param {Function} callback function to invoke with data
 * @return {void}
 * @publish
 */
